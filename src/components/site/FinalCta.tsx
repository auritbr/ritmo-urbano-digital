      ...
      <div className="container-site">
        <div className="relative overflow-hidden rounded-lg border border-ink-line bg-ink-soft p-6 md:p-10">
          <img
            ...
            alt="Apresentação cultural em palco comunitário"
          ...
          <div className="relative grid gap-8 md:grid-cols-[1fr_auto] md:items-end">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-3 font-display text-3xl font-bold leading-tight tracking-[-0.02em] md:text-5xl">
                {title}
              </h2>
          ...
          <span className="pointer-events-none absolute -bottom-4 right-4 font-display text-7xl font-bold uppercase leading-none text-ink-outline opacity-20 md:text-9xl">
            Cultura
          </span>
        </div>
      </div>
